      ...
      >
        <Container>
          ...
          >
            ...
            >
              I'm a passionate designer and developer
              specializing in creating beautiful, functional
              digital experiences. With expertise in both UX
              design and front-end development, I build
              solutions that look great and perform
              exceptionally.
            </p>
          </FlexCol>
        </Container>
            ...
            <FlexCol style={{ maxWidth: '400px' }}>
              <h3
                style={{
                  color: 'white',
                  fontSize:
                    'var(--heading-font-size-lg, 1.5rem)',
                  fontWeight: 600,
                  marginBottom: 16,
                }}
              >
